...
const ProductCards = () => {
  ...
  return (
    <>
      <section className=" bg-black  mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8 lg:min-h-screen">
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {products ? (
                ...
                <Link to={`/product/${product._id}`}>
                  ...
                  >
                    ...
                    <div className="mt-4 flex justify-between">
                      <div>
                        <h3 className="text-sm text-gray-300 line-clamp-1">
                          <span
                            aria-hidden="true"
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <p className="text-sm font-md text-gray-300">
            ...
            <>
              <p className="text-gray-200">ahh! We cound not find anything</p>
            </>
          )}
        </div>
      </section>
